...
func (r *ProxyRegistry) SyncFromApply(clientId uuid.UUID, desired map[string]utils.ProxiesApplyMsgItem) error {
...
func (r *ProxyRegistry) upsert(clientId uuid.UUID, name string, proxy utils.ProxiesApplyMsgItem) error {
